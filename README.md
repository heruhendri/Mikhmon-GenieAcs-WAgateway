...
# Mikhmon PPPoE GenieAcs-WAgateway

[![License](https://img.shields.io/github/license/heruhendri/Mikhmon-GenieAcs-WAgateway.svg)](LICENSE)
[![Stars](https://img.shields.io/github/stars/heruhendri/Mikhmon-GenieAcs-WAgateway)](https://github.com/heruhendri/mikhmon-pppoe-v6/stargazers)
[![Forks](https://img.shields.io/github/forks/heruhendri/Mikhmon-GenieAcs-WAgateway.svg)](https://github.com/heruhendri/Mikhmon-GenieAcs-WAgateway/network/members)
...
* Subdomain (misalnya `mikhmon-genieacs.hendri.site`)
...
```bash
git clone https://github.com/heruhendri/Mikhmon-GenieAcs-WAgateway mikhmon-genieacs
```
...
```bash
nano /etc/nginx/sites-available/mikhmon-genieacs.conf
```
...
server {
    listen 80;
    server_name mikhmon-genieacs.hendri.site;

    root /var/www/html/mikhmon-genieacs;
...
```bash
ln -s /etc/nginx/sites-available/mikhmon-genieacs.conf /etc/nginx/sites-enabled/
```
...
certbot --nginx -d mikhmon-genieacs.hendri.site
```
...
```
https://mikhmon-genieacs.hendri.site
```
...
| Lokasi web     | `/var/www/html/mikhmon-genieacs/`                           |
| Backup         | `zip -r mikhmon-genieacs-backup.zip /var/www/html/mikhmon/` |
...
### 2. **Download Mikhmon-genieacs**

Masuk ke folder web (default di nginx biasanya `/var/www/html/`):

```bash
cd /var/www/html/
wget git clone https://github.com/heruhendri/Mikhmon-GenieAcs-WAgateway.git mikhmon-genieacs -O mikhmon-genieacs.zip
unzip mikhmon-henieacs.zip
mv mikhmonv-genieacs-master mikhmon-genieacs
```

Instance pertama sudah ada di `/var/www/html/mikhmon-genieacs`

---

### 3. **Tambah Instance Lain**

Kalau mau multi-instal (misalnya `mikhmon-genieacs2`, `mikhmon-genieacs3`):

```bash
cp -r /var/www/html/mikhmon-genieacs1 /var/www/html/mikhmon-genieacs2
cp -r /var/www/html/mikhmon-genieacs1 /var/www/html/mikhmon-genieacs3
```

Jadi ada:

* `/var/www/html/mikhmon-genieacs1`
* `/var/www/html/mikhmon-genieacs2`
* `/var/www/html/mikhmon-genieacs3`
