    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h3><i class="fa fa-server"></i> <?= $_genieacs ?> Management</h3>
            </div>
            <div class="card-body">
                <?php if ($action == 'list'): ?>
                    <!-- Device List -->
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <h4 class="mb-0"><?= $_genieacs_devices ?></h4>
                        <a href="./?genieacs&action=list&session=<?= $session; ?>&debug=true" class="btn btn-info btn-sm">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            <td><?php echo htmlspecialchars($device_id); ?></td>
                                            <td><?php echo htmlspecialchars($pon_mode); ?></td>
                                            <td><?php echo htmlspecialchars($model); ?></td>
                                            <td><?php echo htmlspecialchars($serial_number); ?></td>
                                            <td><?php echo htmlspecialchars($pppoe_id); ?></td>
                                            <td><?php echo htmlspecialchars($rx_power); ?><?php echo ($rx_power !== 'N/A' && $rx_power !== '') ? ' dBm' : ''; ?></td>
                                            <td><?php echo htmlspecialchars($last_inform); ?></td>
                                            <td><?php echo htmlspecialchars($active_connections); ?></td>
                                            <td>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <table class="table table-sm table-borderless">
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo htmlspecialchars(extract_nested_value($device_data, array('VirtualParameters.gettemp'))); ?><?php echo (extract_nested_value($device_data, array('VirtualParameters.gettemp')) !== 'N/A') ? '°C' : ''; ?></td>
                                            </tr>
                                            <tr>
